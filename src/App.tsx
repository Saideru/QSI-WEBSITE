      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0 flex items-center">
            <img src="QSI_LOGO.png" alt="QSI Logo" className="h-12 w-auto" referrerPolicy="no-referrer" />
          </div>
        ...
        <div className="h-40 overflow-hidden relative border-b border-white/10">
          ...
          {job.cobrand && (
            <div className="absolute top-2 left-2 flex gap-2">
               <img src="QSI_LOGO.png" alt="QSI" className="h-5 bg-white p-0.5 rounded shadow" referrerPolicy="no-referrer" />
               <img src="W_Hydrocloroidsinc.png" alt="W Hydrocolloids" className="h-5 bg-white p-0.5 rounded shadow" referrerPolicy="no-referrer" />
            </div>
          )}
        </div>
    ...
    <section id="clients" className="py-20 bg-qsi-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="max-w-3xl mx-auto bg-white p-12 rounded-[50px] shadow-xl border-t-8 border-partner-blue flex flex-col items-center">
          <img src="W_Hydrocloroidsinc.png" alt="W Hydrocolloids" className="h-24 mb-8" referrerPolicy="no-referrer" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2">
            <img src="QSI_LOGO.png" alt="QSI Logo" className="h-16 mb-6" referrerPolicy="no-referrer" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-gray-100 gap-6">
          <div className="flex items-center gap-6">
            <div className="flex flex-col items-center">
              ...
              <img src="W_Hydrocloroidsinc.png" alt="W Hydrocolloids" className="h-10" referrerPolicy="no-referrer" />
            </div>
          </div>
